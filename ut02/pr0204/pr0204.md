...
### Apartado 1
El proceso que consume más **CPU**, se encuentra en el primer lugar y cambia cada 5 segundos por defecto.
...
- **NI:** Valor `nice`, que determina la prioridad del proceso (un valor más bajo significa mayor prioridad).
...
- **%CPU:** Porcentaje de uso de la CPU que el proceso está consumiendo.

- **%MEM:** Porcentaje de memoria RAM física total utilizada por el proceso.

- **TIME+:** Tiempo total acumulado que el proceso ha estado ejecutándose.
