...
### Apartado 2
Para matar un proceso, usamos `kill -9`, tenemos que ver el ID del proceso para poder ponerlo al final del propio comando. Para ello, pondremos `ps aux | egrep sleep`
