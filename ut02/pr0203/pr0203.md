...
- [📦 Creación de las máquinas](#📦-creación-de-las-máquinas)

- [🔧 Configurar la red de **SERVER-A**](#🔧-configurar-la-red-de-server-a)

- [🔧 Configurar la red de **SERVER-B** y **SERVER-C**](#🔧-configurar-la-red-de-server-b-y-server-c)
    - [📦 SERVER-B](#📦-server-b)

    - [📦 SERVER-C](#📦-server-c)

- [🔑 Creación y configuración de claves **SSH**](#🔑-creación-y-configuración-de-claves-ssh)
...
vamos a intentar conectarnos por **SSH** desde la terminal anfitriona (debería de pasar igual que en SERVER-B). Al haber puesto `ssh sysadmin@10.30.0.20` y esperar un tiempo, sale este mensaje:
...
Ahora crearemos las claves **SSH** para conectarnos sin la contraseña. Lo haremos conectados por **SSH** desde la terminal anfitriona a **SERVER-A** y lo configuraremos todo desde ahí.
