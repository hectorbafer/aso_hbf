...
> 💬 Para estos ejercicios lo haré también como **Administrador** para evitar fallos al poner el comando.
...
![Ficheros y directorios](Imagenes/Ej2-1.png)
...
![Ficheros más de 50000 bytes](Imagenes/Ej2-3.png)
...
![Ficheros ordenados](Imagenes/Ej2-4.png)
...
![Tamaño y nombre de ficheros](Imagenes/Ej2-5.png)
...
![Tamaño más de 10MB](Imagenes/Ej2-6.png)
...
```powershell
Get-ChildItem C:\Windows\System32\ | Where-Object Extension -eq ".exe" |Select-Object Length, FullName | Sort-Object Length | Where-Object Length -gt 10000000
```

![Ficheros más de 10MB](Imagenes/Ej2-7.png)
...
![Estado Responding](Imagenes/Ej3-1.png)
...
![Ficheros con fecha](Imagenes/Ej3-2.png)
