...
> 💬 Al guardar el archivo, lo más seguro es que tengamos problemas al guardarlo por falta de permisos, nos recomienda guardarlo como un archivo `.txt` y guardarlo en `Documents`. Podemos quitarle la extensión y reemplazar el archivo viejo.
...
Para editar el archivo **hosts**, pondremos el comando `notepad C:\Windows\System32\drivers\etc\hosts`, se nos abrirá el **Bloc de notas** y lo dejaremos exactamente igual que en la versión **GUI**, es decir, al final del documento pondremos esto:
```
192.168.1.10 HBF-2019
192.168.1.20 HBF-CORE-2019
192.168.1.30 HBF-CORE-2016
