...
Para acabar con la configuración inicial, comprobamos que se hagan ping entre ellas, he puesto el comando `ping` más el nombre del **Host** de las máquinas para que aparezcan tanto el nombre y la IP que tienen.
