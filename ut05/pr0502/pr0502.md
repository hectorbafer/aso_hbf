...
![Script inicio de sesión](Imagenes/Ej3_2.png)
...
Creamos una nueva carpeta que se llamará `Practica` y haremos lo mismo que con la carpeta anterior y en el archivo `.bat` pondremos:
```
